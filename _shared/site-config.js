...
logos: {
  ...
  nfc:             'https://ik.imagekit.io/r2zdlyze2o/Logo/nfc-logo.png',
  customWebApp:    favicon('web.dev'),

  // ── Added: keys referenced by case-study pages (fixes broken logos) ──
  supabase:        favicon('supabase.com'),
  vercel:          favicon('vercel.com'),
  postgresql:      favicon('postgresql.org'),
  zohoCRM:         favicon('zoho.com/crm'),
  zohoProjects:    favicon('zoho.com/projects'),
  gohighlevel:     favicon('gohighlevel.com'),
  lalamove:        favicon('lalamove.com'),
  flodesk:         favicon('flodesk.com'),
  blotato:         favicon('blotato.com'),
  creatomate:      favicon('creatomate.com'),
  'bright-data':   favicon('brightdata.com'),
  fattureincloud:  favicon('fattureincloud.it'),
  manatal:         favicon('manatal.com'),
  midjourney:      favicon('midjourney.com'),
  huggingface:     favicon('huggingface.co'),
  openrouter:      favicon('openrouter.ai'),
  replicate:       favicon('replicate.com'),
  reddit:          favicon('reddit.com'),
  sendgrid:        favicon('sendgrid.com'),
  lemlist:         favicon('lemlist.com'),
  'respond-io':    favicon('respond.io'),
  zadarma:         favicon('zadarma.com'),
  telnyx:          favicon('telnyx.com'),
  klap:            favicon('klap.app'),
  kie:             favicon('kie.ai'),
  sintra:          favicon('sintra.ai'),
  googleAnalytics: favicon('analytics.google.com'),
  'google-cloud-firestore': favicon('firebase.google.com'),
  // Aliases → reuse existing definitions so alternate keys still resolve
  googleMaps:      favicon('maps.google.com'),
  ...
  crm:             favicon('zoho.com/crm'),
  'retail-express':favicon('retailexpress.com.au'),
  retailexpress:   favicon('retailexpress.com.au'),
  // Generic / protocol icons (no brand) → neutral favicons
  api:             favicon('developer.mozilla.org'),
  'http-request':  favicon('developer.mozilla.org'),
  jwt:             favicon('jwt.io'),
  'data-table':    'https://ssl.gstatic.com/docs/spreadsheets/favicon3.ico',

  // ── Added: keys referenced by multi-channel-agent-performance-analytics case study ──
  justcall:        'https://ik.imagekit.io/r2zdlyze2o/Logo/justcall.png?updatedAt=1784888229737',
