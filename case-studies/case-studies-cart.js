...
window.CS_CARDS = [
  ...
  /* ── 24 ── */
  {
    ...
    tag: "AI-Powered",
    title: "Power Apps Service Request System",
  ...
  /* ── 32 ── */
  {
    ...
    tag: "AI-Powered",
    title: "Telegram Image Analysis Automation",
  ...
  /* ── 33 ── */
  {
    ...
    tag: "AI-Powered",
    title: "Apps Script Task Management + WhatsApp",
  ...
  /* ── 45 ── */
  {
    ...
    tag: "AI-Powered",
    title: "AI Google Ads Lead Automation",
  ...
  /* ── 46 ── */
  {
    ...
    tag: "Operations",
    title: "Shipment Tracking via Terminal 49",
  ...
  /* ── 47 ── */
  {
    ...
    tag: "AI-Powered",
    title: "AI Call QA & Compliance Automation",
    ...
    tag: "Operations",
    title: "Cleaning Workforce Automation",
  ...
  },
  {
    ...
    tag: "AI-Powered",
    title: "AI Bid Qualification System",
  ...
  },
  {
    ...
    imgAlt: "Multi-Channel Agent Performance Analytics Dashboards",
    tag: "E-Commerce",
    title: "Multi-Channel Agent Performance Analytics",
    desc: "Unified JustCall and Gorgias into a single BigQuery pipeline with cross-platform identity resolution, feeding live Looker Studio dashboards that show agent performance across every call and ticket — refreshed daily with no manual work.",
    meta: "Sales Operations",
